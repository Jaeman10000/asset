...
# ── Threads(합니다체 완결형, 처음 보는 사람 기준) + 첫 답글 ──
# JJ 2026-09-12 기준: 이 글만 읽고 이해되게 쓴다. ① 무슨 일이 있었나 → ② 그래서 돈이 어디로 갔나 → ③ 무슨 뜻일 수 있나.
# 축약 종결('팜/오름/봄')·채팅 기호·우리끼리 쓰는 카운터(확인 N번 중 M번)는 쓰지 않는다. 숫자는 무엇이 얼마나 움직였는지 풀어 쓴다.
...
TH_HOOK = {"oil_x1": ["기름값이 한 주 만에 배럴당 {L}달러를 넘었습니다.", "이번 주 기름값이 올라 배럴당 {L}달러를 넘겼습니다.",
                      "미국에서 사고파는 기름이 배럴당 {L}달러 위로 올라섰습니다."],
           "oil_x0": ["기름값이 한 주 만에 배럴당 {L}달러 아래로 내려왔습니다.", "이번 주 기름값이 내려 배럴당 {L}달러를 밑돌았습니다.",
                      "미국에서 사고파는 기름이 배럴당 {L}달러 아래로 내려섰습니다."],
           "oil1": ["기름값이 이번 주 {p} 올랐습니다.", "이번 주 기름값이 {p} 올라 배럴당 {lvl}입니다.", "미국 기름값은 한 주 동안 {p} 올랐습니다."],
           "oil0": ["기름값이 이번 주 {p} 내렸습니다.", "이번 주 기름값이 {p} 내려 배럴당 {lvl}입니다.", "미국 기름값은 한 주 동안 {p} 내렸습니다."],
           "rate1": ["미국이 10년 빌리는 돈에 붙는 이자가 {lvl}까지 올랐습니다.", "이번 주 미국에서 돈 빌리는 값이 {pp} 올랐습니다.",
                     "미국 나랏빚에 붙는 이자는 한 주 {pp} 올라 {lvl}입니다."],
           "rate0": ["미국이 10년 빌리는 돈에 붙는 이자가 {lvl}까지 내려왔습니다.", "이번 주 미국에서 돈 빌리는 값이 {pp} 내렸습니다.",
                     "미국 나랏빚에 붙는 이자는 한 주 {pp} 내려 {lvl}입니다."],
           "idx1": ["{nm_i_ga} 이번 주 {p} 올랐습니다.", "이번 주 미국 시장에서 {nm_i_ga} {p} 올랐습니다.", "{nm_eun} 한 주 동안 {p} 올랐습니다."],
           "idx0": ["{nm_i_ga} 이번 주 {p} 내렸습니다.", "이번 주 미국 시장에서 {nm_i_ga} {p} 내렸습니다.", "{nm_eun} 한 주 동안 {p} 내렸습니다."],
           "idxd1": ["{nm_i_ga} {wd} 하루에만 {p} 올랐습니다.", "{wd} 하루 동안 {nm_i_ga} {p} 올랐습니다.", "{nm_eun} {wd}에만 {p} 뛰었습니다."],
           "idxd0": ["{nm_i_ga} {wd} 하루에만 {p} 내렸습니다.", "{wd} 하루 동안 {nm_i_ga} {p} 내렸습니다.", "{nm_eun} {wd}에만 {p} 밀렸습니다."],
           "gen": ["{v}.", "이번 주 {v2}.", "{v3}."]}
TH_SAME = {1: ["문을 연 {nd} 동안 하루도 빠지지 않았습니다.", "{nd} 내리 오르기만 했습니다.", "한 주 내내 오르는 날만 이어졌습니다."],
           0: ["문을 연 {nd} 동안 하루도 오르지 못했습니다.", "{nd} 내리 내리기만 했습니다.", "한 주 내내 내리는 날만 이어졌습니다."]}
TH_BIGGEST = ["이번 주 미국 시장에서 가장 크게 움직인 숫자입니다.", "한 주 동안 가장 크게 움직인 쪽이 여기였습니다.", "이번 주 숫자 가운데 움직임이 가장 컸습니다."]
TH_Q = {"macro": ["그럼 주식은 어떻게 움직였을까요?", "이 숫자는 주식에 어떻게 닿았을까요?", "그 사이 돈은 어디로 갔을까요?"],
        "idx": ["그럼 돈은 어디로 움직였을까요?", "그 안에서 어디가 오르고 어디가 밀렸을까요?", "한 주 동안 무슨 일이 있었을까요?"]}
TH_IX = {"all0": ["그 사이 나스닥은 하루도 오르지 못했습니다.", "나스닥은 {nd} 내리 내렸습니다.", "나스닥은 {nd} 연속으로 내렸습니다."],
         "all1": ["그 사이 나스닥은 하루도 내리지 않았습니다.", "나스닥은 {nd} 내리 올랐습니다.", "나스닥은 {nd} 연속으로 올랐습니다."],
         "gen": ["그 사이 나스닥은 한 주 {p} {v}습니다.", "나스닥은 한 주 동안 {p} {v}습니다.", "같은 기간 나스닥은 {p} {v}습니다."]}
TH_RATE = {1: ["미국이 10년 빌리는 돈의 이자도 {lvl}까지 올랐습니다.", "같은 기간 미국 나랏빚 이자는 {lvl}로 올랐습니다.", "돈 빌리는 값도 한 주 {pp} 올랐습니다."],
           0: ["미국이 10년 빌리는 돈의 이자는 {lvl}까지 내려왔습니다.", "같은 기간 미국 나랏빚 이자는 {lvl}로 내렸습니다.", "돈 빌리는 값은 한 주 {pp} 내렸습니다."]}
TH_OIL = {1: ["기름값도 한 주 {p} 올랐습니다.", "같은 기간 기름값도 {p} 올라 배럴당 {lvl}입니다.", "미국 기름값도 한 주 동안 {p} 올랐습니다."],
          0: ["기름값은 한 주 {p} 내렸습니다.", "같은 기간 기름값은 {p} 내려 배럴당 {lvl}입니다.", "미국 기름값은 한 주 동안 {p} 내렸습니다."]}
TH_SECTOR = {"mix": ["분야로 보면 {top_i_ga} 가장 많이 올랐고, {bot_i_ga} 가장 많이 내렸습니다.", "가장 많이 오른 곳은 {top}, 가장 많이 내린 곳은 {bot_ieot}습니다.",
                     "오른 쪽은 {top}, 내린 쪽은 {bot_ieot}습니다."],
             "one": ["{tot} 분야 가운데 오른 곳은 {top} 하나였습니다.", "오른 곳은 {top} 한 곳뿐이었습니다.", "{top_eul} 빼면 모든 분야가 내렸습니다."],
             "none": ["{tot} 분야가 모두 내렸습니다.", "오른 곳은 한 곳도 없었습니다.", "분야는 하나도 남김없이 내렸습니다."],
             "all": ["{tot} 분야가 모두 올랐습니다.", "내린 곳은 한 곳도 없었습니다.", "분야는 하나도 빠짐없이 올랐습니다."]}
TH_MEGA = ["덩치 큰 회사 가운데서는 {nm_i_ga} 한 주 {p} {v}습니다.", "가장 크게 움직인 큰 회사는 {nm}, 한 주 {p} {v}습니다.",
           "{nm_eun} 한 주 {p} {v}고, 큰 회사 가운데 움직임이 가장 컸습니다."]
TH_FALL = ["이번 주는 숫자가 크게 움직이지 않았습니다.", "한 주 동안 큰 변화는 없었습니다.", "이번 주 미국 시장은 조용한 편이었습니다."]
TH_READ = {"rate_oil": ["이자도 기름값도 함께 올라간 한 주였습니다.", "이번 주는 이자와 기름값이 나란히 오른 주로 보입니다.", "빌리는 값도 기름값도 위를 본 한 주였습니다."],
           "rate": ["이번 주 시장의 중심은 이자 쪽에 있었습니다.", "주식보다 돈 빌리는 값이 더 크게 움직인 한 주로 보입니다.", "한 주 내내 이자가 기준이 된 모습입니다."],
           "oil": ["이번 주는 기름값이 가장 크게 움직였습니다.", "시장의 눈이 기름값 쪽에 쏠린 한 주로 보입니다.", "한 주 내내 기름값이 앞에 있었습니다."],
           "up": ["미국 주식은 오르는 쪽으로 한 주를 마쳤습니다.", "미국 주식은 위쪽을 보고 한 주를 닫았습니다.", "주식은 오른 자리에서 한 주를 마무리했습니다."],
           "down": ["미국 주식은 내리는 쪽으로 한 주를 마쳤습니다.", "미국 주식은 아래쪽을 보고 한 주를 닫았습니다.", "주식은 내린 자리에서 한 주를 마무리했습니다."],
           "flat": ["큰 방향 없이 지나간 한 주였습니다.", "이번 주 미국 주식은 방향을 정하지 못했습니다.", "위아래가 섞인 채로 한 주가 지났습니다."]}
# 첫 문단 두 줄(JJ 2026-09-13) — 1줄은 읽는 사람이 이미 본 것(주말 뉴스에 뜬 미국 주식 방향),
# 2줄은 그것만 보면 놓치는 '숫자가 든' 사실이다. 빈손 예고('확인할 숫자는 따로 있습니다')는 쓰지 않는다.
# 1줄은 같은 어미만 반복하면 AI 티가 나므로 여섯 가지를 주차로 돌리고, '보셨을 겁니다'는 여섯 중 하나로만 둔다.
TH_OPEN1 = {"down": ["이번 주 미국 주식이 내렸다는 소식은 이미 뉴스에 나왔습니다.",
                     "주말 뉴스마다 미국 주식이 내렸다는 이야기가 돌았습니다.",
                     "미국 주식이 한 주 내내 밀렸다는 건 뉴스로 이미 보셨을 겁니다.",
                     "간밤 뉴스 화면에 뜬 미국 주식 하락, 거기까지는 다들 봤습니다.",
                     "뉴욕 주식이 내렸다는 이야기는 어제오늘 뉴스에 계속 나왔습니다.",
                     "포털 첫 화면에도 미국 주식이 내렸다고 떠 있었습니다."],
            "up": ["이번 주 미국 주식이 올랐다는 소식은 이미 뉴스에 나왔습니다.",
                   "주말 뉴스마다 미국 주식이 올랐다는 이야기가 돌았습니다.",
                   "미국 주식이 한 주 내내 올랐다는 건 뉴스로 이미 보셨을 겁니다.",
                   "간밤 뉴스 화면에 뜬 미국 주식 상승, 거기까지는 다들 봤습니다.",
                   "뉴욕 주식이 올랐다는 이야기는 어제오늘 뉴스에 계속 나왔습니다.",
                   "포털 첫 화면에도 미국 주식이 올랐다고 떠 있었습니다."],
            "flat": ["이번 주 미국 주식이 잠잠했다는 소식은 뉴스에 나왔습니다.",
                     "주말 뉴스에도 미국 주식은 이렇다 할 이야기가 없었습니다.",
                     "미국 주식이 한 주 내내 제자리였다는 건 이미 보셨을 겁니다.",
                     "간밤 뉴스 화면에 뜬 미국 주식, 거기까지는 다들 봤습니다.",
                     "뉴욕 주식이 방향을 못 잡았다는 이야기는 뉴스에 계속 나왔습니다.",
                     "포털 첫 화면에도 미국 주식은 거의 그대로 떠 있었습니다."]}
# 2줄 — 월요일 한국 시장으로 건너오는 숫자. 반도체가 첫째고, 없으면 달러 값·나스닥·이자 순으로 내려간다.
# 여기 쓴 숫자는 아래 답 묶음에서 빼서 같은 말을 두 번 하지 않는다.
TH_LINE2 = {"SOX": ["그런데 미국 반도체 주식은 한 주 {p} {v}습니다.",
                    "정작 미국 반도체 주식은 한 주 동안 {p} {v}습니다.",
                    "한국 반도체가 따라 보는 미국 반도체는 한 주 {p} {v}습니다.",
                    "뉴스에 덜 나온 숫자는 미국 반도체입니다. 한 주 {p} {v}습니다."],
            "USDKRW": ["그런데 달러 한 장 값이 한 주 사이 {won} {vk}습니다.",
                       "정작 한국으로 넘어오는 숫자는 달러 값입니다. 한 주 {won} {vk}습니다.",
                       "같은 기간 달러 한 장 값은 {won} {vk}습니다.",
                       "뉴스에 덜 나온 숫자는 달러 값입니다. 한 주 {won} {vk}습니다."],
            "IXIC": ["그런데 나스닥만 떼어 보면 한 주 {p} {v}습니다.",
                     "정작 나스닥은 한 주 동안 {p} {v}습니다.",
                     "숫자로 보면 나스닥은 한 주 {p} {v}습니다.",
                     "뉴스에 덜 나온 숫자는 나스닥입니다. 한 주 {p} {v}습니다."],
            "US10Y": ["그런데 미국이 10년 빌리는 돈의 이자가 한 주 {pp} {v}습니다.",
                      "정작 크게 움직인 건 이자입니다. 한 주 {pp} {v}습니다.",
                      "같은 기간 미국 나랏빚 이자는 {lvl}가 됐습니다.",
                      "뉴스에 덜 나온 숫자는 이자입니다. 한 주 {pp} {v}습니다."]}
# 2줄에 쓴 숫자가 무엇인지 한 줄로 풀어 준다 — 처음 보는 사람은 '미국 반도체'가 뭘 묶은 숫자인지 모른다.
TH_LINE3 = {"SOX": ["미국에서 반도체를 만드는 회사들의 주가를 한데 묶은 숫자입니다.",
                    "미국에 있는 반도체 회사들의 주가를 한 줄로 모은 숫자입니다.",
                    "엔비디아처럼 미국에서 반도체를 만드는 회사들을 묶은 숫자입니다."],
            "USDKRW": ["달러 한 장을 사려면 원화를 얼마 내야 하는지 나타낸 값입니다.",
                       "달러 한 장을 바꿔 오는 데 드는 원화 값입니다.",
                       "우리 돈으로 달러 한 장을 사는 데 드는 값입니다."]}
# 달러 값 — 미국 숫자가 한국 계산으로 넘어오는 또 하나의 통로(우선순위 4: 자리가 남을 때만 붙는다)
TH_FX = {0: ["달러 한 장 값은 한 주 사이 {won} 내렸습니다.", "같은 기간 달러 값도 {won} 내려왔습니다.", "달러를 사는 값이 한 주 동안 {won} 내렸습니다."],
         1: ["달러 한 장 값은 한 주 사이 {won} 올랐습니다.", "같은 기간 달러 값도 {won} 올라섰습니다.", "달러를 사는 값이 한 주 동안 {won} 올랐습니다."]}
# 마지막 줄 — '그래서 무슨 뜻'. 월요일에 무엇을 확인하겠다는 고지는 답글이 맡는다.
TH_MEAN = {"down": ["미국에서 반도체가 먼저 밀린 채 끝난 한 주로 남았습니다.",
                    "월요일 한국 반도체가 이어받는 숫자는 아래쪽에 있습니다.",
                    "한국 반도체 앞에 놓인 미국 숫자는 내려간 쪽입니다.",
                    "한국 반도체가 건네받을 숫자가 위쪽은 아니었습니다."],
           "up": ["미국에서 반도체가 먼저 오른 채 끝난 한 주로 남았습니다.",
                  "월요일 한국 반도체가 이어받는 숫자는 위쪽에 있습니다.",
                  "한국 반도체 앞에 놓인 미국 숫자는 올라간 쪽입니다.",
                  "한국 반도체가 건네받을 숫자가 아래쪽은 아니었습니다."],
           "flat": ["미국에서 반도체는 어느 쪽도 고르지 않고 한 주를 끝냈습니다.",
                    "월요일 한국 반도체가 이어받는 숫자는 뚜렷하지 않습니다.",
                    "한국 반도체 앞에 놓인 미국 숫자는 방향이 없습니다.",
                    "한국 반도체가 건네받을 숫자는 어느 쪽도 아닌 자리입니다."]}
...
TH_REPLY_CH = ["주말엔 미국 한 주를, 평일엔 오후 4시 30분 한국 시장 마감 이야기입니다.",
               "주말에는 미국 한 주, 평일에는 오후 4시 30분 한국 시장 마감을 담습니다.",
               "평일 오후 4시 30분엔 한국 시장 마감, 주말엔 미국 한 주를 담습니다."]
TH_MAX_CHARS, TH_MAX_FIGS, TH_MAX_LINE = 500, 6, 40
TH_MIN_CHARS = 350                                          # 목표 하한(JJ 2026-09-13): 350~420자
TH_MIN_LINES, TH_MAX_LINES = 8, 17                          # 빈 줄 포함 본문 줄 수(태그 줄 제외)
TH_OPEN_END = re.compile(r"(?:습니다|입니다|겁니다)\.$")       # 첫 문단 두 줄은 완결형으로 끝난다
TH_END_OK = re.compile(r"(?:습니다|입니다|겁니다)\.?$|\?$")    # 완결형 또는 질문으로 끝나야 한다('~겁니다'는 JJ 예시 문장)
TH_UM_END = re.compile(r"(?:팜|함|짐|음|봄|옴|뜀|감|김|남|임|삼|킴|섬|밈|림)\s*\.{0,3}$")   # 축약 종결(음슴체)
...
def _da(phrase: str) -> str:
    """'엔화 한 주 1.3% 약세' → '엔화가 한 주 1.3% 약해졌습니다' (완결형 끝말 + 주어 조사)."""
    head, sep, tail = (phrase or "").partition(" 한 주 ")
    s = f"{i_ga(head)} 한 주 {tail}" if sep else (phrase or "")
    for a_, b_ in (("급등", "크게 올랐습니다"), ("급락", "크게 내렸습니다"), ("상승", "올랐습니다"), ("하락", "내렸습니다"),
                   ("강세", "강해졌습니다"), ("약세", "약해졌습니다")):
        if s.endswith(a_):
            return s[:-len(a_)] + b_
    return s + "입니다"
...
def build_threads(C: dict, P: Pick, hook: dict, line1: str) -> tuple[str, str]:
    """(본문+태그, 첫 답글). 블록 사이에 빈 줄 —
    ①첫 문단 2줄(뉴스로 이미 본 미국 주식 방향 + 그것만 보면 놓치는 숫자) ②이번 주 숫자 ③질문 ④어디로 갔나 ⑤무슨 뜻.
    ...
    def lay(items: list[tuple[int, str]]) -> list[str]:
        out: list[str] = []
        for blk in (opening, head, [q], [t for _, t in sorted(items)], tail):
            if not blk:
                continue
            if out:
                out.append("")
    ...
    reply = (f"영상 전체는 여기서 → {YT}\n"
             ...
             f"월요일 한국 시장에서는 {P(f'th.reply.{sd}', REPLY_Q[sd])} 보겠습니다.")
    return body + "\n" + TAG, reply
...
def run_checks(out: dict) -> list[str]:
    ...
    for x in live + [y.strip() for y in out["threads_reply"].split("\n")[1:] if y.strip()]:
        ...
        if not TH_END_OK.search(x):                         # 완결형('-습니다/-입니다')이나 질문으로 끝나야 한다
            why.append(f"threads 완결형 아님: {x}")
        if TH_UM_END.search(x):                             # '팜/오름/봄' 같은 축약 종결
