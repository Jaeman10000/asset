...
- **평일 시간표:** 15:31 수집+대본 → **15:40 대본을 JJ에게 먼저 보낸다**(예약 작업 `nugasatna-script-preview`) → 15:55 그 대본 그대로 음성·영상(재생성 금지) → 17:00 업로드. JJ가 대본을 고치라 하면 compute 를 다시 돌리고 tts·render·review 를 다시 한다.
